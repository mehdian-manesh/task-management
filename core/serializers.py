...
from django.contrib.auth.models import User  # If needed for user fields
...
class WorkingDaySerializer(serializers.ModelSerializer):
    reports = serializers.PrimaryKeyRelatedField(many=True, read_only=True)  # Or use a nested ReportSerializer if full details are needed
